...
def train_one_epoch(model_stage1, teacher, optimizer, data_loader_reg, data_loader_sa):
    ...
    for data_iter_step, (reg_img0, reg_img1, reg_conf_gt) in enumerate(data_loader_reg):
        ...
        if data_iter_step % 10 == 0:
            print('data_iter:', data_iter_step, 'reg_loss:', loss_reg, 'sa_loss:', loss_sa,  'sloss:',
                  student_loss)
...
if __name__ == '__main__':
    ...
    Reg_data = RegDataset('/home/xhs/data/train2017', '/home/xhs/data/PseudoInfrared')
    ...
    model_stage1 = Feature_Extraction()
    ...
    if use_registration_teacher == True:
        ...
        teacher.load_state_dict(torch.load("/home/xhs/code/semla/weight/matchformer.ckpt"), strict=False)
    ...
    for epoch in range(0, epochs):
        ...
        scheduler.step()
        torch.save(model_stage1.state_dict(), '/home/xhs/code/semla/weight/stage1_{}epoch.ckpt'.format(epoch))
