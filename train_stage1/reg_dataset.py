...
class RegDataset(Dataset):
    def __init__(self, data_path_vi, data_path_ir):
        ...
        data_floder = os.listdir(data_path_vi)
        data = []
        ...
        self.train_size_w = 320
        self.train_size_h = 240
        self.num_of_points = (self.train_size_w / 8) * (self.train_size_h / 8)
    ...
    def __getitem__(self, idx):
        ...
        image_vi = cv2.imread(image_name, cv2.IMREAD_GRAYSCALE)
        ...
        image_ir = cv2.imread(os.path.join(self.data_path_ir, image_name), cv2.IMREAD_GRAYSCALE)
